...
💡 Pre-load: Carbs 2-3hrs before`,
    ...
    segments: [
      ...
      // Interval 1
      {
        ...
        duration: 180,
        power: 0.95,
        messages: [{ time: 10, text: 'Interval 1/3 - Under @ 95%' }],
      },
      {
        type: 'steady',
        duration: 120,
        power: 1.05,
        messages: [{ time: 10, text: 'Over @ 105% - push!' }],
      },
      {
        type: 'steady',
        duration: 180,
        power: 0.95,
        messages: [{ time: 10, text: 'Back under @ 95%' }],
      },
      ...
      // Interval 2
      {
        ...
        duration: 180,
        power: 0.95,
        messages: [{ time: 10, text: 'Interval 2/3' }],
      },
      ...
      // Interval 3
      {
        ...
        duration: 180,
        power: 0.95,
        messages: [{ time: 10, text: 'Interval 3/3 - Final one!' }],
      },
      {
        type: 'steady',
        duration: 120,
