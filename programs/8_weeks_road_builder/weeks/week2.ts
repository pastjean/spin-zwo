...
📊 ~92 TSS · IF 0.86`,
    ...
    segments: [
      ...
      // Set 1: 10x40/20
      { type: "steady", duration: 40, power: 1.2, messages: [{ time: 5, text: "Set 1/4 - 40/20s!" }] },
      ...
      // Set 2: 10x40/20
      { type: "steady", duration: 40, power: 1.2, messages: [{ time: 5, text: "Set 2/4" }] },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 40, power: 1.2 },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 40, power: 1.2 },
      ...
      { type: "steady", duration: 240, power: 0.5 },
      // Set 3: 10x40/20
      { type: "steady", duration: 40, power: 1.2, messages: [{ time: 5, text: "Set 3/4" }] },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 40, power: 1.2 },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 40, power: 1.2 },
      ...
      { type: "steady", duration: 40, power: 1.2 },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 40, power: 1.2, messages: [{ time: 5, text: "Final interval of set 3!" }] },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 240, power: 0.5 },
      // Set 4: 10x40/20
      { type: "steady", duration: 40, power: 1.2, messages: [{ time: 5, text: "Set 4/4 - Final set!" }] },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 40, power: 1.2 },
      { type: "steady", duration: 20, power: 0.5 },
      { type: "steady", duration: 40, power: 1.2 },
